...
export interface RtcSession {
  ...
  /** Publish (or, with null, unpublish) a screen-share track — a separate,
   *  content-optimized track (T2.06). */
  publishScreen?(track: MediaStreamTrack | null, encodings: ScreenEncoding[]): void;
  leave(): Promise<void>;
}
